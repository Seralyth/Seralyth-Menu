    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Disable Tutorial Block", enableMethod =() => GetObject("Environment Objects/LocalObjects_Prefab/ForestToHoverboard/TurnOnInForestAndHoverboard/ForestDome_CollisionOnly/TutorialMapDomeCap_FBX/Tutorial_DomeBlock_Collision").SetActive(false), disableMethod =() => GetObject("Environment Objects/LocalObjects_Prefab/ForestToHoverboard/TurnOnInForestAndHoverboard/ForestDome_CollisionOnly/TutorialMapDomeCap_FBX/Tutorial_DomeBlock_Collision").SetActive(true), toolTip = "Disables the tutorial block collisions" },
